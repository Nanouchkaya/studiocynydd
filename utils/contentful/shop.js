...
export async function getProducts() { // only general informations for cards view
  const allProducts = await getClient().getEntries({
    ...
    select: 'sys.createdAt,fields.slug,fields.productName,fields.price,fields.images,fields.bestSeller,fields.categories,fields.discount,fields.variations,fields.stock',
  })
