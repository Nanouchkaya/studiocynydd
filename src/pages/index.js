...
import { getAdvertisements, getAssetById, getBlockContentBySection, getFeaturedItems, getInstaFeed, getLastPrestation, getTestimonials } from '@utils/contentful';
                                    
const HomePage = (props) => {
  return(
    <React.Fragment>
      {/*<SVGTag />*/}
      <Layout herologo={props.herologo} slogan={props.slogan} advertisements={props.advertisements} >
        <H1>Bienvenue !</H1>
